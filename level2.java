...
public class level2 extends World
{
    ...
    protected void add_objects(){
        if (Greenfoot.getRandomNumber(30)==1)
        {
            ...
            {
                addObject(new Snake1(),800,Greenfoot.getRandomNumber(2)*70+230);
                count=0;
                count1 ++;
            }
        }
        if (Greenfoot.getRandomNumber(500)==1)
        {
            if ( count1 >= 2 )
            {
                addObject(new Life1(),800,Greenfoot.getRandomNumber(2)*70+230);
                count1 = 0;
            }
        ...
        if (Greenfoot.getRandomNumber(500)==1)
        {
            addObject(new Power(),800,Greenfoot.getRandomNumber(2)*70+230);
        }
    ...
    protected void add_flies(){
        if (Helicopter && Heli_flag)
        {
            fly_count++;
            if ((fly_count % 20 ==0)){
                addObject(new Points1(),getWidth()-1, Greenfoot.getRandomNumber(200));
            }
            if ((fly_count % 30 ==0)){
                addObject(new Points1(),getWidth()-1, Greenfoot.getRandomNumber(200));
            }
            ...
            if (Greenfoot.getRandomNumber(150)==10){
                addObject(new Points1(),800,Greenfoot.getRandomNumber(2)*70+230);
            }
...
public void tambahskor()
    {
        score++;//menambah skor
        if(score >= 20)//jika skor mencapai 30 maka akan melakukan kondisi dibawah
        {
            addObject(new win(), 400, 160);// melanjutkan ke level 2
            Greenfoot.playSound("TaDa.mp3");
            Greenfoot.setWorld(new Instructions());
            backgroundMusic.pause();//memjeda music
